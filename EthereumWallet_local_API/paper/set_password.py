...
try:
 ...
 #   global font, uppic,nextpic
    ...
    drawblack.text((20, 0), 'Set your password', font = font24, fill = 0)
    drawblack.line((40, 100, 225, 100), fill = 0)


    '''
    drawblack.line((90, 100, 125, 100), fill = 0)
    drawblack.line((140, 100, 175, 100), fill = 0)
    drawblack.line((190, 100, 225, 100), fill = 0)
    '''
